...
import numpy as np
from cka.gram import gram_linear, _center_gram, gram_rbf
...
class IncrementalCKA:
    ...
    def increment_cka_score(self, index_feature_x: int, index_feature_y: int, features_x: np.ndarray,
        ...
        # since computing terms used in the denom of cka is duplicated,
    ...
    def cka(self) -> np.ndarray:
        ...
        Returns: `np.ndarray` whose element is cka. The shape is `num_layers_0` \times `num_layers_1`.
